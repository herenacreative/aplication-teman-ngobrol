...
import {Card, Title, Paragraph, Avatar, Headline, FAB, Divider, Subheader,Button, Subheading} from 'react-native-paper';
    ...
    return (
      <ScrollView>
        <View style={style.container}>
          ...
          <FAB style={style.fab} small icon="pencil"  onPress={() => this.props.navigation.navigate('RegisterNew')} />
        </View>
      </ScrollView>
    );
  }
